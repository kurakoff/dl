...
export default function NotesButton({ accountId, siteUrl }) {
  ...
  // Indicator: has content?
  const hasContent = loaded && content.length > 0;
  ...
  return (
    <div className="relative" ref={popoverRef}>
      <button
        ...
        title="Notes"
      >
        <svg className="w-3.5 h-3.5" fill={hasContent ? 'currentColor' : 'none'} viewBox="0 0 24 24" stroke="currentColor">
